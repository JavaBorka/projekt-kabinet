...
export const PaginatedList = ({itemsPerPage}) => {
    ...
    getPostsPreviewWithCategoryName(itemsPerPage, currentPage, setTotalPages, BASE_API_URL, stripHTMLTags)
    ...
    useEffect(() => {
        getPostsPreviewWithCategoryName(itemsPerPage, currentPage, setTotalPages, BASE_API_URL, stripHTMLTags).then((data) => {
            setItems(data)
        })
    }, [currentPage])
