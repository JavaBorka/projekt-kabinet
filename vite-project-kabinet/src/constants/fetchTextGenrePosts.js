...
export const fetchTextGenrePosts = async (perPage, page) => {
    ...
    const reqPosts = await fetch(`${BASE_API_URL}/posts/?_embed&categories=${WP_CAT_ID_PROSE},${WP_CAT_ID_POEM},${WP_CAT_ID_DIARY},${WP_CAT_ID_INTERVIEW},${WP_CAT_ID_REVIEW}&per_page=${perPage}&page=${page}&${ts()}`)
